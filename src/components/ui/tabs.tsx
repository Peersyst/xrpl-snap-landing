...
const variantStyles: Record<TabsListVariant, string> = {
    line: cn(
        // base
        "flex sm:flex-col border-b sm:border-b-0 sm:border-l",
        // border color
...
function getVariantStyles(tabVariant: TabsListVariant) {
    switch (tabVariant) {
        case "line":
            return cn(
                // base
                "whitespace-nowrap border-b-2 sm:border-b-0 sm:border-l-2 border-transparent sm:pl-10 text-sm font-medium transition-all",
                // text color
                "text-gray-500 dark:text-gray-500",
                // hover
                "hover:text-gray-700 hover:dark:text-gray-400",
                // border hover
                "hover:border-gray-300 hover:dark:border-primary/50",
                // selected
                "data-[state=active]:border-gray-900 data-[state=active]:text-gray-900",
                "data-[state=active]:dark:border-primary data-[state=active]:dark:text-gray-50",
                // disabled
