...
const HeroLines = () => {
    ...
    const drawPurpleLine1 = (draw: Element, refX: number, refY: number) => {
    ...
    const drawPurpleLine2 = (draw: Element, refX: number, refY: number) => {
    ...
    const drawPurpleLine3 = (draw: Element, refX: number, refY: number) => {
    ...
    const drawGreenLine1 = (draw: Element, refX: number, refY: number) => {
    ...
    const drawGreenLine2 = (draw: Element, refX: number, refY: number) => {
    ...
    const drawGreenLine3 = (draw: Element, refX: number, refY: number) => {
    ...
    const drawLine = (
        ...
        yFinal: number,
        xFirstCorner: number,
        xSecondCorner: number,
        cornerRadius: number,
        color: string,
        topOrBottom: string,
    ) => {
        const screenWidth = window.innerWidth;
        const gradient = draw.gradient("linear", function (add: { stop: (arg0: number, arg1: string) => void }) {
            ...
            clone: () => {
                ...
                fill: {
                    (arg0: string): {
                        (): any;
                        new (): any;
                        stroke: { (arg0: { width: number; color: any; opacity: number }): any; new (): any };
                    };
                    new (): any;
                };
            };
    ...
    const animateMask = (
        worm: {
            ...
            animate: (
                ...
                new (): any;
                during: {
                    (arg0: (pos: any) => void): { (): any; new (): any; after: { (arg0: () => void): void; new (): any } };
                    new (): any;
                };
            };
            center: (arg0: any, arg1: any) => void;
            hide: () => void;
        },
        path: { length: () => any; pointAt: (arg0: number) => any },
        wormPath: { show: () => void; hide: () => void },
        orientation: string,
    ) => {
    ...
    return <svg ref={svgRef} style={{ position: "absolute", left: 0, top: 0, width: "100%", height: "100%" }} />;
};
