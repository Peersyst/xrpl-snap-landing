...
export function Footer(): JSX.Element {
    return (
        <footer className="bg-[#2B2B2E] relative">
            <div className="mx-auto max-w-4xl w-full h-52 flex flex-col sm:flex-row sm:justify-between py-6 sm:pt-16 px-4 lg:px-0 gap-5">
            ...
            <img
                ...
                alt="footer-image"
                className="absolute top-0 sm:top-auto sm:bottom-0 inset-x-1/3 h-20 sm:h-36 rotate-180 sm:rotate-0"
            />
        </footer>
    );
}
